 ...
 * C 標準形式のコメントが定数 TRADITIONAL_COMMENT それぞれ表される．
...
extends CodeLineMap
{
    ...
    /** マップ上で，その文字が C 標準形式のコメントであることを表す値 */
    public static final String TRADITIONAL_COMMENT = "3";
    
    /** マップ上で，その文字が C 標準形式のコメントであり，なおかつ，実行コードのコメントアウトであることを表す値 */
    ...
    /**
     * C 標準形式のコメントアウトの文字数を返す．
     *
     * @return C 標準形式のコメントアウトの文字数
     */
     ...
     * 内容は (b?,c?,#?:t?,e?,j?,ec?,tc?) ....... 
     * という形式になっており，
     * それぞれ順番に空白類の文字数，コード文字数，コメント文字数，Traditional コメント文字数，EOL コメント文字数，Javadoc 文字数（未対応のため0），
